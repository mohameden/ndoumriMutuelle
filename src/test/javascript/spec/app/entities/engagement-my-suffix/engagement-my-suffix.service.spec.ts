...
describe('Service Tests', () => {
    ...
    describe('EngagementMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EngagementMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/engagements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return EngagementMySuffix', () => {
