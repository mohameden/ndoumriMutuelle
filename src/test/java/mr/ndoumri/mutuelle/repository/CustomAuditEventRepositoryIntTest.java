...
import mr.ndoumri.mutuelle.config.audit.AuditEventConverter;
import mr.ndoumri.mutuelle.domain.PersistentAuditEvent;
...
import static mr.ndoumri.mutuelle.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
